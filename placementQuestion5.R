...
df_mom_edu <- data.frame(
  ...
  student_employ_test = as.vector(placementData$etest_p)
)
...
ggplot(df_mom_job, aes(x = stringr::str_to_title(factor(student_mom_job)), y = student_employ_test, color = stringr::str_to_title(factor(student_mom_job)))) +
  geom_violin(trim = FALSE, alpha = 0.6, linewidth = 1.2) +
  scale_color_manual(values = c("#F7B538", "#DB7C26", "#D8572A", "#C32F27", "#780116")) +
  labs(
...
ggplot(df_dad_job, aes(x = stringr::str_to_title(factor(student_dad_job)), y = student_employ_test, color = stringr::str_to_title(factor(student_dad_job)))) +
  geom_violin(trim = FALSE, alpha = 0.6, linewidth = 1.2) +
  scale_color_manual(values = c("#F7B538", "#DB7C26", "#D8572A", "#C32F27", "#780116")) +
  labs(
...
ggplot(df_famsup, aes(x = stringr::str_to_title(factor(student_famsup)), y = student_employ_test, color = stringr::str_to_title(factor(student_famsup)))) +
  geom_violin(trim = FALSE, alpha = 0.6, linewidth = 1.2) +
...
ggplot(df_paid, aes(x = stringr::str_to_title(factor(student_paid)), y = student_employ_test, color = stringr::str_to_title(factor(student_paid)))) +
  geom_violin(trim = FALSE, alpha = 0.6, linewidth = 1.2) +
  scale_color_manual(values = c("#60712F", "#274029")) +
  labs(
    x = "Paid Classes", 
...
ggplot(df_activities, aes(x = stringr::str_to_title(factor(student_activities)), y = student_employ_test, color = stringr::str_to_title(factor(student_activities)))) +
  geom_violin(trim = FALSE, alpha = 0.6, linewidth = 1.2) +
  scale_color_manual(values = c("#60712F", "#274029")) +
  labs(
...
ggplot(df_internet, aes(x = stringr::str_to_title(factor(student_internet)), y = student_employ_test, color = stringr::str_to_title(factor(student_internet)))) +
  geom_violin(trim = FALSE, alpha = 0.6, linewidth = 1.2) +
  scale_color_manual(values = c("#60712F", "#274029")) +
  labs(
    x = "Internet Access", 
...
ggplot(df_secondary_board, aes(x = stringr::str_to_title(factor(student_secondary_board)), y = student_employ_test, color = stringr::str_to_title(factor(student_secondary_board)))) +
  geom_violin(trim = FALSE, alpha = 0.6, linewidth = 1.2) +
...
ggplot(df_higher_secondary_board, aes(x = stringr::str_to_title(factor(student_higher_secondary_board)), y = student_employ_test, color = stringr::str_to_title(factor(student_higher_secondary_board)))) +
  geom_violin(trim = FALSE, alpha = 0.6, linewidth = 1.2) +
  scale_color_manual(values = c("#1282A2", "#005CB3", "#002D7A")) +
  labs(
